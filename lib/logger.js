...
Logger.prototype['perf:dashboard:frontier:page_ready_by_page'] = function pageReadyByPageLogger() {
  this.dfds.push(Performance.fromSplunkPageReadyByPage(this.data));
};

Logger.prototype['perf:dashboard:frontier:page_ready_histogram'] = function pageReadyHistogram() {
  this.dfds.push(Performance.fromSplunkHistogram(this.data));
};
